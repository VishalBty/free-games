...
app.controller("ConfigController", function ($scope, $rootScope, api) {
  ...
  $scope.configAttr = {
    ...
    MaxConcurrentTask: { t: "number", desc: "Maxmium downloading game tasks allowed." },
    SeedRatio: { t: "number", desc: "The ratio of task Upload/Download data when reached, the task will be stopped." },
    UploadRate: {
      t: "text",
      desc: "Upload speed limiter, Low(~50k/s), Medium(~500k/s) and High(~1500k/s) is accepted , Unlimited / 0 or empty result in unlimited rate, or a customed value eg: 850k/720kb/2.85MB. ",
    },
    DownloadRate: {
      t: "text",
      desc: "Download speed limiter, Low(~50k/s), Medium(~500k/s) and High(~1500k/s) is accepted , Unlimited / 0 or empty result in unlimited rate, or a customed value eg: 850k/720kb/2.85MB. ",
    },
    TrackerList: { t: "multiline", desc: 'A list of trackers to add to games, prefix with "remote:" will be retrived with http.' },
    AlwaysAddTrackers: { t: "check", desc: "Whether add trackers even there are trackers specified in the game/magnet" },
